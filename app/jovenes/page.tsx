...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Finanzas para Jóvenes en España — Primer Sueldo, Ahorro e Inversión",
    description: "Aprende a gestionar tu primer sueldo, ahorrar e invertir en fondos indexados desde joven. Guía práctica para estudiantes y recién graduados en España.",
...
export default function JovenesPage() {
  ...
  const jovenesFAQs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "En España, las tarjetas de crédito no funcionan exactamente igual que en EEUU para construir historial crediticio. Lo más importante aquí es no aparecer en ficheros de morosos (ASNEF, RAI) y mantener buenas referencias bancarias. Si quieres una tarjeta, muchos bancos ofrecen tarjetas para jóvenes sin comisiones. Úsala y paga el saldo completo cada mes.",
    },
    {
    ...
    {
      question: "¿Cómo puedo generar ingresos extra siendo estudiante en España?",
      answer: "Hay muchas opciones: clases particulares (muy demandadas en todas las ciudades), trabajos de media jornada compatibles con el horario de clase, freelancing en Fiverr o Workana, venta de apuntes y materiales online, reparto flexible (Glovo, Uber Eats), o prácticas remuneradas. Busca opciones que te den experiencia profesional y complementen tus estudios.",
    },
  ]
    ...
    <div className="py-16 sm:py-20">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl">Finanzas para Jóvenes en España: Ahorra e Invierte desde el Primer Sueldo</h1>
          <p className="mt-6 text-lg leading-8 text-muted-foreground">
            Guía práctica para estudiantes y jóvenes profesionales en España. Aprende a gestionar tu dinero, ahorrar y empezar a invertir en fondos indexados desde 50 €/mes.
          </p>
        </div>
            ...
            <div className="prose prose-lg max-w-none prose-headings:text-foreground prose-p:text-foreground prose-strong:text-foreground prose-li:text-foreground space-y-8">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-7 mt-4">
                  <li><strong>Presupuesto funcional:</strong> No tiene que ser complicado. Usa una app como Fintonic o Wallet (disponibles en España), o simplemente una hoja de cálculo. Lo importante es saber a dónde va tu dinero cada mes.</li>
                  <li><strong>Fondo de emergencia:</strong> Tu primer objetivo debe ser ahorrar 1.000-2.000 €. Esto te protege de recurrir a deuda cuando surjan imprevistos como reparaciones del coche o gastos médicos inesperados.</li>
                  <li><strong>Cuenta remunerada o fondo monetario:</strong> En España puedes poner tu fondo de emergencia en cuentas remuneradas (Trade Republic ofrece hasta un 3% TAE) o en fondos monetarios disponibles en MyInvestor. Tu dinero trabaja mientras lo tienes disponible.</li>
                  <li><strong>Educación continua:</strong> Dedica 15-30 minutos semanales a leer sobre finanzas personales. Los conocimientos que adquieres ahora te servirán durante toda tu vida.</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-7 mt-4">
                  Como joven, puedes permitirte tomar más riesgos porque tienes tiempo para recuperarte de las caídas del mercado. Esto significa que puedes tener una cartera más agresiva (90% acciones, 10% bonos). En España, los fondos indexados más accesibles para empezar son el Amundi MSCI World o el Vanguard Global Stock Index, disponibles en MyInvestor o Indexa Capital desde 150-250 €. Para importes más pequeños, Trade Republic permite comprar ETFs desde 1 €.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-7 mt-4">
                  ...
                  Crea un plan de pago agresivo. Cada euro que pagas en intereses es dinero que no está trabajando para ti.</li>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            <Card>
              <CardHeader>
                <CardTitle>Apps Gratuitas en España</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">Fintonic, Wallet, Spendee — gestiona gastos y presupuesto en español</p>
