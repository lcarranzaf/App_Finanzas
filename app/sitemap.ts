...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { path: "/calculadoras",                       date: "2026-04-16", priority: 0.8,  changeFrequency: "monthly" as const },
    { path: "/calculadoras/hipoteca",              date: "2026-04-16", priority: 0.9,  changeFrequency: "monthly" as const },
