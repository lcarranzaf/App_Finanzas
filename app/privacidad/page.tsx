...
export const metadata: Metadata = {
  ...
  robots: "index, follow",
  alternates: {
    canonical: "https://finanzaspro.com/privacidad",
  },
}
    ...
    <article className="py-16 sm:py-20">
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none prose-headings:text-foreground prose-p:text-foreground prose-strong:text-foreground prose-li:text-foreground prose-a:text-primary hover:prose-a:underline">
          ...
          <p>
            Para ejercer estos derechos, contáctanos en: <strong>contacto@finanzaspro.com</strong>
          </p>
          ...
          <ul>
            <li>
              <strong>Email:</strong> contacto@finanzaspro.com
            </li>
            <li>
              <strong>Sitio web:</strong> https://finanzaspro.com
            </li>
          </ul>
